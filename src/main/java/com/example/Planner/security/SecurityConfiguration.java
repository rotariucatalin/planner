...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/contact/deleteContact/**").hasAuthority("Delete_Contact")
                .antMatchers("/contact/exportExcel/**").hasAuthority("View_Contact")
                .antMatchers("/inquiry/**").hasAuthority("View_Inquiry")
                .antMatchers("/inquiry/addInquiry/**").hasAuthority("Add_Inquiry")
                .antMatchers("/inquiry/saveInquiry/**").hasAuthority("Add_Inquiry")
                .antMatchers("/inquiry/editInquiry/**").hasAuthority("Edit_Inquiry")
                .antMatchers("/inquiry/updateInquiry/**").hasAuthority("Edit_Inquiry")
                .antMatchers("/inquiry/deleteInquiry/**").hasAuthority("Delete_Inquiry")
